...
<div class="ManagerForm">
	<form name="Form1" method="post" action="realupdatesection_${updatesectionlist[2]}.do" language="javascript" onsubmit="javascript:return check();" id="Form1">
                ...
                <td width="50%" align="left" valign="top"  class="panelbox">
                    <table width="100%">
                        <tr>
						    ...
						    <td width="338">
							    <input class=FormBase id=sName value="${updatesectionlist[0]}" onBlur="this.className='FormBase';" style="WIDTH: 200px" onFocus="this.className='FormFocus';" type=text name=sName>
							</td>
                            <td width="98">&nbsp;<br></td>
                            <td width="374"><br></td>
                        </tr>
                        <tr>
						    ...
						    <td width="338">
							    <input class=FormBase id=uName onBlur="this.className='FormBase';" style="WIDTH: 200px" onFocus="this.className='FormFocus';" type=text name=uName value="${updatesectionlist[1]}" >
							</td>
                   	</tr> 
                  </table>
                </td>
