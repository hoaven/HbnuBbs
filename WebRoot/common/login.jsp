...
<!--      导航        -->
<DIV>
	&gt;&gt;<B><a href="${pageContext.request.contextPath}/common/index.jsp">论坛首页</a></B>
</DIV>
<!--      用户登录表单        -->
...
<FORM name="loginForm" onSubmit="return check()" action="login.do" method="post"> 
...
<%
  ...
  <tr>
    <td height="100" align="center" valign="middle"><h1>提示信息 </h1>
      <p>您已经登录，无须重复登录 </p>
    <p><a href="/${pageContext.request.contextPath}">如果浏览器没有转向, 请点击这里. </a></p></td>
  </tr>
	</table>
<%
	}
