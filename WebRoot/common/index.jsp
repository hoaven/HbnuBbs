...
<BODY>
	...
	<DIV class="t">
		<%
			listParent = section_dao.getSectionById(0); //获取所有的父板块（封装到list中）
		...
		<TABLE cellSpacing="0" cellPadding="0" width="100%">
			...
			<TR class="tr3">
				...
				<TD align="center">
					<%-- 板块内帖子数目 --%> <%=listChild.get(j).getStopiccount()%></TD>
				<TH>
					<%
 ...
 %> <%-- 最后发帖的标题==做成链接 --%> <SPAN><A
				...
				</SPAN> <BR /> <%-- 最后跟帖的作者 --%> <SPAN><%=temp1.getAuthor()%></SPAN> <%-- 最后发帖的时间 --%>
