<%@ page language="java" contentType="text/html; charset=gbk"
	pageEncoding="gbk"%>
<%@ page import="java.util.*,com.kakanshun.dao.*,com.kakanshun.page.*"%>
<%
...
%>
	<B> >>
	<a href="${pageContext.request.contextPath}/servletListPage?sid=<%=page_list.get(i).getSid()%>"><%=page_list.get(i).getSname()%></a>
	</B>
<%
	}
