...
<%
	...
	if(temp==null){
%>
	<FORM name="regForm" onSubmit="return check()" action="regist.do" method="post">
	...
	%>
	<meta http-equiv="refresh" content="2; url=/HbnuBbs" />
	<table width="80%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="100" align="center" valign="middle"><h1>提示信息 </h1>
      <p>不能重复注册用户 </p>
    <p><a href="/HbnuBbs">如果浏览器没有转向, 请点击这里. </a></p></td>
  </tr>
	</table>
<%
	}
